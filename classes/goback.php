...
class goback_refrr {
	...
	function go()
	{
		if(isset($_GET["goback_refrr"]))
		{
			header("Location: " . urldecode($_GET["goback_refrr"]));
			exit;
		}
	}
	...
	function hinput()
	{
		if(isset($_SERVER["HTTP_REFERER"]) && isset($_SERVER["REDIRECT_URL"]) && !ereg($_SERVER["REDIRECT_URL"], $_SERVER["HTTP_REFERER"]))
			return "\n<input type=\"hidden\" name=\"goback_refrr\" value=\"" . $_SERVER["HTTP_REFERER"] . "\">";
	}
}
